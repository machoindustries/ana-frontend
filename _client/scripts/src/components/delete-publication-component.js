...
class DeletePublicationComponent extends BaseComponent {
    constructor() {
        super();
        ...
        this.defaultOptions = {
            ...
            lightboxConfirmSrcName: 'publicationconfirmdelete',
            idAttr: 'data-id',
        };
    }
    ...
    _delete($modalContent, $confirmBtn) {
        ...
        APIProxy.request({
            ...
            success: () => {
                ...
                globalEmitter.emit('deletepublication:deleted', this);
            ...
            error: (jqxhr) => {
                ...
                Utils.handleAjaxError(jqxhr, {
                    ...
                    context: 'DeletePublicationComponent._delete',
                });
            },
        });
    }
...
export default () => {
    return new DeletePublicationComponent();
};