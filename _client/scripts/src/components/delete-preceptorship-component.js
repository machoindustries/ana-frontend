...
class DeletePreceptorshipComponent extends BaseComponent {
    constructor() {
        super();
        ...
        this.defaultOptions = {
            ...
            lightboxConfirmSrcName: 'preceptorshipconfirmdelete',
            idAttr: 'data-id',
        };
    }
    ...
    _delete($modalContent, $confirmBtn) {
        ...
        APIProxy.request({
            ...
            success: () => {
                ...
                globalEmitter.emit('deletepreceptorship:deleted', this);
            ...
            error: (jqxhr) => {
                ...
                Utils.handleAjaxError(jqxhr, {
                    ...
                    context: 'DeletePreceptorshipComponent._delete',
                });
            },
        });
    }
...
export default () => {
    return new DeletePreceptorshipComponent();
};