...
class DeleteProfessionalServiceComponent extends BaseComponent {
    constructor() {
        super();
        ...
        this.defaultOptions = {
            ...
            lightboxConfirmSrcName: 'professionalserviceconfirmdelete',
            idAttr: 'data-id',
        };
    }
    ...
    _delete($modalContent, $confirmBtn) {
        ...
        APIProxy.request({
            ...
            success: () => {
                ...
                globalEmitter.emit('deleteprofessionalservice:deleted', this);
            ...
            error: (jqxhr) => {
                ...
                Utils.handleAjaxError(jqxhr, {
                    ...
                    context: 'DeleteProfessionalServiceComponent._delete',
                });
            },
        });
    }
...
export default () => {
    return new DeleteProfessionalServiceComponent();
};