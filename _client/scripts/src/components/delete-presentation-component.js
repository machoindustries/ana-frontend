...
class DeletePresentationComponent extends BaseComponent {
    constructor() {
        super();
        ...
        this.defaultOptions = {
            ...
            lightboxConfirmSrcName: 'presentationconfirmdelete',
            idAttr: 'data-id',
        };
    }
    ...
    _delete($modalContent, $confirmBtn) {
        ...
        APIProxy.request({
            ...
            success: () => {
                ...
                globalEmitter.emit('deletepresentation:deleted', this);
            ...
            error: (jqxhr) => {
                ...
                Utils.handleAjaxError(jqxhr, {
                    ...
                    context: 'DeletePresentationComponent._delete',
                });
            },
        });
    }
...
export default () => {
    return new DeletePresentationComponent();
};