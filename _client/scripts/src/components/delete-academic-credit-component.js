...
class DeleteAcademicCreditComponent extends BaseComponent {
    constructor() {
        super();
        ...
        this.defaultOptions = {
            ...
            lightboxConfirmSrcName: 'creditconfirmdelete',
            idAttr: 'data-id',
        };
    }
    ...
    _delete($modalContent, $confirmBtn) {
        ...
        APIProxy.request({
            ...
            success: () => {
                ...
                globalEmitter.emit('deleteacademiccredit:deleted', this);
            ...
            error: (jqxhr) => {
                ...
                Utils.handleAjaxError(jqxhr, {
                    ...
                    context: 'DeleteAcademicCreditComponent._delete',
                });
            },
        });
    }
...
export default () => {
    return new DeleteAcademicCreditComponent();
};