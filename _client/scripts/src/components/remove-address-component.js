...
class RemoveAddressComponent extends BaseComponent {
    constructor() {
        super();

        this.defaultOptions = {
            selectors: {
                lightboxConfirmButton: '[data-address-confirm-removal]',
            },
            lightboxConfirmSrcName: 'removeaddressconfirmation',
        };
    }
    ...
    _deleteAction(e) {
        ...
        APIProxy.request({
            ...
            success: (data) => {
                ...
                globalEmitter.emit('removeaddress:dataupdated', self);
            },
...
export default () => {
    return new RemoveAddressComponent();
};
